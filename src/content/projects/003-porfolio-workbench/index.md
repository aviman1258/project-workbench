...
description: A local-first workspace for documenting projects and collecting artifacts without giving up file-based ownership.
why: The workbench keeps project documentation close to its underlying files instead of making a hosted service the source of truth.
status: dev
privacy: public
